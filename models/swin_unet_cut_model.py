...
class SwinUnetCUTModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--netF', type=str, default='swin', choices=['sample', 'reshape', 'mlp_sample', 'swin'], help='how to downsample the feature map')
    ...
    def __init__(self, opt):
        ...
        self.netP = networks.define_G(
            2*opt.input_nc, opt.output_nc, opt.ngf, opt.netG, opt.normG, not opt.no_dropout, opt.init_type, opt.init_gain,
            opt.no_antialias, opt.no_antialias_up, opt.gpu_ids, opt, img_size=opt.crop_size
        )
